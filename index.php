                ...
                <div class="post__main">
                    ...
                    <?php elseif ($post['type'] === 'post-photo'): ?>
                        <div class="post-photo__image-wrapper">
                            <img src="img/<?= $post['content']; ?>" alt="Фото от пользователя <?= $post['user-name']; ?>" width="360" height="240">
                        </div>
                    <?php elseif ($post['type'] === 'post-link'): ?>
                        <div class="post-link__wrapper">
                            <a class="post-link__external" href="//<?= $post['content']; ?>" title="Перейти по ссылке <?= $post['content']; ?>">
                                <div class="post-link__info-wrapper">
                                    <div class="post-link__icon-wrapper">
                                        <img src="//www.google.com/s2/favicons?domain=<?= $post['content']; ?>" alt="Иконка <?= $post['content']; ?>">
                                    </div>
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                ...
                                <img class="post__author-avatar" src="img/<?= $post['avatar']; ?>" alt="Аватар пользователя <?= $post['user-name']; ?>">
                            </div>
